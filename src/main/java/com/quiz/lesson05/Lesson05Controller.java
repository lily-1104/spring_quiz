...
public class Lesson05Controller {
	...
	// 2. JSTL Core 라이브러리 (2)
	// URL : http://localhost:8080/lesson05/quiz02
	@GetMapping("/quiz02")
	public String quiz02(Model model) {		// List 담으려면 Model 담기
	...
	// 3. JSTL fmt 라이브러리
	// URL : http://localhost:8080/lesson05/quiz03
	@GetMapping("/quiz03")
	public String quiz03(Model model) {
		
		
		// 3-1. JSTL Formatter 숫자, 비율
		...
		model.addAttribute("cardBills", cardBills);		// 위의 List<Map<String, Object>> cardBills 때문에 "cardBills" 사용
	...
	// 4. JSTL fn 라이브러리
	// URL : http://localhost:8080/lesson05/quiz04
	@GetMapping("/quiz04")
